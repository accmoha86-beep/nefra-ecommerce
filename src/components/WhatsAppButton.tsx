...
export const WhatsAppButton: React.FC<WhatsAppButtonProps> = ({ t, currentCountry, lang, siteSettings }) => {
  const [open, setOpen] = useState(false);

  const whatsappNumber = currentCountry.whatsappNumber || '201000000000';
  const message = siteSettings?.whatsappDefaultMessage?.[lang] || (lang === 'ar' 
