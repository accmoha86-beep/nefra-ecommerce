    ...
    <div className="shop-page">
      ...
      <div className="shop-topbar">
        <div className="shop-topbar-left">
          ...
          {ff('ff_product_count') && <span className="shop-count">{filtered.length} {t('heroStatProducts')}</span>}
        </div>
        <div className="shop-topbar-right">
          ...
          {ff('ff_sort_options') && <select className="shop-sort-select" value={sort} onChange={e => setSort(e.target.value)}>
