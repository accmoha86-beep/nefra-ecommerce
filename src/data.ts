...
export const categories: CategoryInfo[] = [
  { name:'Brush Sets', nameAr:'أطقم فرش', nameIt:'Set Pennelli', emoji:'🖌️', count:6, grad:'from-pink-400 to-rose-600', enabled:true },
  { name:'Lashes', nameAr:'رموش', nameIt:'Ciglia', emoji:'👁️', count:2, grad:'from-gray-500 to-gray-700', enabled:true },
  { name:'Face', nameAr:'الوجه', nameIt:'Viso', emoji:'✨', count:3, grad:'from-amber-400 to-yellow-500', enabled:true },
  { name:'Eyes', nameAr:'العيون', nameIt:'Occhi', emoji:'🎨', count:2, grad:'from-purple-400 to-pink-600', enabled:true },
  { name:'Lips', nameAr:'الشفاه', nameIt:'Labbra', emoji:'💋', count:2, grad:'from-red-400 to-rose-600', enabled:true },
  { name:'Tools', nameAr:'أدوات', nameIt:'Strumenti', emoji:'🧽', count:2, grad:'from-pink-300 to-pink-500', enabled:true },
];
...
export const brandLogos: { name: string; emoji: string }[] = [
  { name: 'Brushia', emoji: '🖌️' },
  { name: 'MAC', emoji: '💄' },
  { name: 'NYX', emoji: '✨' },
  { name: 'Maybelline', emoji: '💋' },
  { name: "L'Oréal", emoji: '🌟' },
  { name: 'Huda Beauty', emoji: '👁️' },
  { name: 'Fenty Beauty', emoji: '💎' },
  { name: 'Charlotte Tilbury', emoji: '👑' },
  { name: 'Too Faced', emoji: '🍑' },
  { name: 'Urban Decay', emoji: '🔥' },
];
